...
var len__5749__auto___23776 = arguments.length;
var i__5750__auto___23778 = (0);
while(true){
if((i__5750__auto___23778 < len__5749__auto___23776)){
args__5755__auto__.push((arguments[i__5750__auto___23778]));

var G__23780 = (i__5750__auto___23778 + (1));
i__5750__auto___23778 = G__23780;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq23760){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23760));
}));
...
var G__23802 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__23802__$1 = (((G__23802 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__23802));
if((G__23802__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__23802__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__23806){
var map__23807 = p__23806;
var map__23807__$1 = cljs.core.__destructure_map.call(null,map__23807);
var handler = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var options = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
var map__23808_23813 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__23808_23814__$1 = cljs.core.__destructure_map.call(null,map__23808_23813);
var status_23815 = cljs.core.get.call(null,map__23808_23814__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_23816 = cljs.core.get.call(null,map__23808_23814__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_23817 = cljs.core.get.call(null,map__23808_23814__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_23818 = cljs.core.get.call(null,map__23808_23814__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_23819 = cljs.core.get.call(null,map__23808_23814__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_23816)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_23816);
} else {
}

if(cljs.core.truth_((function (){var and__5023__auto__ = version_23818;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not_EQ_.call(null,version_23818,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5023__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_23818);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_23815)){
c3kit.wire.api.handle_payload.call(null,handler,payload_23817);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_23815)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_23819);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_23815)){
var G__23809_23820 = options;
var G__23809_23821__$1 = (((G__23809_23820 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__23809_23820));
if((G__23809_23821__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__23809_23821__$1,payload_23817);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_23815)){
var G__23810_23822 = options;
var G__23810_23823__$1 = (((G__23810_23822 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__23810_23822));
if((G__23810_23823__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__23810_23823__$1,payload_23817);
}
} else {
}

var G__23812 = options;
var G__23812__$1 = (((G__23812 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__23812));
if((G__23812__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__23812__$1);
}
});
