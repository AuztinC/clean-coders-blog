...
var G__8426 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__8426,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__8435 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__8435,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__8441 = props;
var G__8441__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__8441,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8441);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__8441__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__8449 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__8449,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__8449;
}
})(),id_class);
...
var className = cljs.core.nth.call(null,vec__8458,(2),null);
...
var temp__5829__auto___8462 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___8462 == null)){
} else {
var key_8463 = temp__5829__auto___8462;
(jsprops.key = key_8463);
}
...
var temp__5829__auto___8464 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___8464 == null)){
} else {
var key_8465 = temp__5829__auto___8464;
(jsprops.key = key_8465);
}
...
var temp__5829__auto___8469 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5829__auto___8469 == null)){
} else {
var key_8470 = temp__5829__auto___8469;
(jsprops.key = key_8470);
}
...
var temp__5829__auto___8477 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___8477 == null)){
} else {
var key_8478 = temp__5829__auto___8477;
(jsprops.key = key_8478);
}
...
var temp__5829__auto___8482 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___8482 == null)){
} else {
var key_8483 = temp__5829__auto___8482;
(jsprops.key = key_8483);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__8476_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__8476_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8479 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__8479,(0),null);
var derefed = cljs.core.nth.call(null,vec__8479,(1),null);
...
break;
default:
var G__8486 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__8487 = compiler;
v = G__8486;
compiler = G__8487;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template8511 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template8511 = (function (opts,id,fn_to_element,parse_fn,meta8512){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta8512 = meta8512;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template8511.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8513,meta8512__$1){
var self__ = this;
var _8513__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8511(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8512__$1));
}));

(reagent.impl.template.t_reagent$impl$template8511.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8513){
var self__ = this;
var _8513__$1 = this;
return self__.meta8512;
}));

(reagent.impl.template.t_reagent$impl$template8511.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8511.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8511.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template8511.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8511.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8511.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8512","meta8512",1234124576,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8511.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8511.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8511");

(reagent.impl.template.t_reagent$impl$template8511.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write.call(null,writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template8511");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8511.
 */
reagent.impl.template.__GT_t_reagent$impl$template8511 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template8511(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8512){
return (new reagent.impl.template.t_reagent$impl$template8511(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8512));
});

}

return (new reagent.impl.template.t_reagent$impl$template8511(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
