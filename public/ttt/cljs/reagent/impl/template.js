...
var G__10079 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10079,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10088__i < G__10088__a.length) {G__10088__a[G__10088__i] = arguments[G__10088__i + 0]; ++G__10088__i;}
  args = new cljs.core.IndexedSeq(G__10088__a,0,null);
} 
return G__10086__delegate.call(this,args);};
G__10086.cljs$lang$maxFixedArity = 0;
G__10086.cljs$lang$applyTo = (function (arglist__10089){
...
var G__10081 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10081,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10092__i < G__10092__a.length) {G__10092__a[G__10092__i] = arguments[G__10092__i + 0]; ++G__10092__i;}
  args = new cljs.core.IndexedSeq(G__10092__a,0,null);
} 
...
var G__10084 = props;
var G__10084__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10084,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10084);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10084__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10087 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10087,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10087;
}
})(),id_class);
...
var G__10090 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10090) {
case (0):
...
var vec__10103 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10103,(0),null);
var id = cljs.core.nth.call(null,vec__10103,(1),null);
var className = cljs.core.nth.call(null,vec__10103,(2),null);
...
var temp__5829__auto___10111 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___10111 == null)){
} else {
var key_10112 = temp__5829__auto___10111;
(jsprops.key = key_10112);
}
...
var temp__5829__auto___10115 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___10115 == null)){
} else {
var key_10119 = temp__5829__auto___10115;
(jsprops.key = key_10119);
}
...
var temp__5829__auto___10137 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5829__auto___10137 == null)){
} else {
var key_10138 = temp__5829__auto___10137;
(jsprops.key = key_10138);
}
...
var temp__5829__auto___10153 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___10153 == null)){
} else {
var key_10154 = temp__5829__auto___10153;
(jsprops.key = key_10154);
}
...
var temp__5829__auto___10158 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___10158 == null)){
} else {
var key_10160 = temp__5829__auto___10158;
(jsprops.key = key_10160);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__10134_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__10134_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__10139 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__10139,(0),null);
var derefed = cljs.core.nth.call(null,vec__10139,(1),null);
...
break;
default:
var G__10185 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__10187 = compiler;
v = G__10185;
compiler = G__10187;
continue;
...
var G__10170 = tag;
var G__10170__$1 = (((G__10170 instanceof cljs.core.Keyword))?G__10170.fqn:null);
switch (G__10170__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template10204 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template10204 = (function (opts,id,fn_to_element,parse_fn,meta10205){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10204.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10206,meta10205__$1){
var self__ = this;
var _10206__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10204(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta10205__$1));
}));

(reagent.impl.template.t_reagent$impl$template10204.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10206){
var self__ = this;
var _10206__$1 = this;
return self__.meta10205;
}));

(reagent.impl.template.t_reagent$impl$template10204.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10204.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10204.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template10204.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10204.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10204.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta10205","meta10205",-403517976,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10204.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10204.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10204");

(reagent.impl.template.t_reagent$impl$template10204.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write.call(null,writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template10204");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10204.
 */
reagent.impl.template.__GT_t_reagent$impl$template10204 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template10204(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10205){
return (new reagent.impl.template.t_reagent$impl$template10204(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10205));
});

}

return (new reagent.impl.template.t_reagent$impl$template10204(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
