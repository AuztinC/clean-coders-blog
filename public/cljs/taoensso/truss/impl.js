...
var ensure_set_8523 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),ensure_set_8523.call(null,ks));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),ensure_set_8523.call(null,ks));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),ensure_set_8523.call(null,ks));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_.call(null,(function (p1__8521_SHARP_){
return (!((cljs.core.get.call(null,m,p1__8521_SHARP_) == null)));
}),ks);
});
...
return cljs.core.into.call(null,cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.mapv.call(null,(function (p1__8524_SHARP_){
return cljs.core.symbol.call(null,"clojure.core",p1__8524_SHARP_);
}),names)),cljs.core.mapv.call(null,(function (p1__8525_SHARP_){
return cljs.core.symbol.call(null,"cljs.core",p1__8525_SHARP_);
}),names));
})();
taoensso.truss.impl.safe_pred = (function taoensso$truss$impl$safe_pred(pred){
return (function (x){
try{return pred.call(null,x);
}catch (e8526){if((e8526 instanceof Error)){
var _ = e8526;
return null;
} else {
throw e8526;
