...
return cljs.core.some.call(null,(function (p1__7710_SHARP_){
return f.call(null,p1__7710_SHARP_,v);
}),ev);
} else {
...
var pred__7715 = cljs.core._EQ_;
var expr__7716 = cljs.core.first.call(null,form);
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,">",">",1085014381,null),expr__7716))){
...
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"<","<",993667236,null),expr__7716))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,">=",">=",1016916022,null),expr__7716))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"<=","<=",1244895369,null),expr__7716))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"like","like",726481451,null),expr__7716))){
return c3kit.apron.test_fabric.pattern_comparator.call(null,cljs.core.second.call(null,form),true);
} else {
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"ilike","ilike",1487249058,null),expr__7716))){
...
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"not=","not=",1466536204,null),expr__7716))){
return cljs.core.complement.call(null,c3kit.apron.test_fabric._or_tester.call(null,cljs.core.rest.call(null,form)));
} else {
if(cljs.core.truth_(pred__7715.call(null,new cljs.core.Symbol(null,"=","=",-1501502141,null),expr__7716))){
...
c3kit.apron.test_fabric.kv__GT_tester = (function c3kit$apron$test_fabric$kv__GT_tester(p__7732){
var vec__7733 = p__7732;
var k = cljs.core.nth.call(null,vec__7733,(0),null);
var v = cljs.core.nth.call(null,vec__7733,(1),null);
